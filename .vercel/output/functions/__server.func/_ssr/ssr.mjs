...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-NquR0EYw.mjs");
...
var manifest = { "03e6b1b9987443e9d02329fe5e84fb55b1b28f597353ec221108524f82b46434": {
	functionName: "extractReceipt_createServerFn_handler",
	importer: () => import("./extract-receipt-Bo4ujaOn.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-LPBKIZup.mjs").then((n) => n.t),
